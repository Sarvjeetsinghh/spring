...
//		--------------SELECT OPERTATION-2--------------
//		int rollno = 135;
//		String select_sql_quries = "SELECT * FROM student WHERE std_roll = ?";
//		
//		List<Student> std_list = jdbcTemplate.query(select_sql_quries, new StudentRowMapper(),rollno);
//		for(Student std : std_list) {
//			System.out.println("Rollno : " + std.getRollno());
//			System.out.println("Name : " + std.getName());
//			System.out.println("Marks : " + std.getMarks());
